...
xbla_dir = os.path.join(home_dir, "emulation/roms/xbla")

# Get the path to the Xbox360/xbla folder
xbla_unpacked_dir = os.path.join(home_dir, "emulation/roms/xbox360/xbla")
